...
public class AppiumSelenideDriver implements WebDriverProvider {
  ...
  public WebDriver createDriver(@Nonnull Capabilities capabilities) {
    ...
    options.setPlatformName(System.getProperty("platformName"));
    options.setDeviceName(System.getProperty("appium:deviceName"));
    options.setPlatformVersion(System.getProperty("appium:platformVersion"));
